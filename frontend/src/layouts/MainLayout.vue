    ...
    <el-aside :width="isCollapsed ? '64px' : '220px'" class="sidebar">
      <div class="logo-section" @click="isCollapsed = !isCollapsed">
        ...
        <transition name="fade">
          <div v-if="!isCollapsed" class="logo-text">
            <h1 class="logo-title">VulnPatch</h1>
            <p class="logo-subtitle">自主多模型调度与案例库<br>自进化的漏洞修复辅助系统</p>
          </div>
        </transition>
      </div>
      ...
      >
        ...
        <el-menu-item index="/findings">
          ...
          <template #title>漏洞发现</template>
        </el-menu-item>
        <el-menu-item index="/evidence">
          <el-icon><Link /></el-icon>
          <template #title>证据链</template>
        </el-menu-item>
        <el-menu-item index="/agents">
          <el-icon><Cpu /></el-icon>
          <template #title>Agent 日志</template>
        </el-menu-item>
    ...
    <el-container>
      <el-header class="main-header">
        ...
        <div class="header-right">
          <el-tag v-if="scanStore.scanning" type="warning" effect="dark" round>
            <el-icon class="is-loading"><Loading /></el-icon>
            扫描中...
          </el-tag>
          <el-badge :value="scanStore.totalFindings" :hidden="scanStore.totalFindings === 0" :max="99">
